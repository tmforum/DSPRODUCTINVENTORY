...
usage() {
	...
	echo "+ +  ${nom} [-p -i id] Full update element with default file"
	echo "+ +  ${nom} [-p -i id -f file ] Full update element with specified file"
	echo "+ +  ${nom} [-u -i id] Partial update element with default file"
	echo "+ +  ${nom} [-u -i id -f file ] Partial update element with specified file"
